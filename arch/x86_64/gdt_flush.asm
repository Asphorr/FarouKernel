...
section .text
global gdt_flush, load_tss, exception_handler, setup_gdt
...
exception_handler:
    ; Basic exception handler (uses interrupt vector 0x0E as an example)
    ; This should be replaced with specific handlers for various exceptions.
    cli
    hlt
    ret
...
initialize_tss:
    ...
    xor rax, rax
    mov qword [tss + 0x00], rax ; rsp0
    mov qword [tss + 0x08], rax ; rsp1
    mov qword [tss + 0x10], rax ; rsp2
